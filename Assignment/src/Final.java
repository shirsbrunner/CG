...
{	
	...
	{		
		...
		VertexData vKnot = reader.read("./Objects/C__fakepath_dog3.obj", 5f);
		Shape sKnot = new Shape(vKnot);
		nsrotBod = new ShapeNode();
		nsrotBod.setShape(sKnot);
		...
		appleMaterial.loadTexture("textures/tribal.jpg");
		...
		sKnot.setMaterial(appleMaterial);
